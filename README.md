...
* Pour compiler tous les fichiers d'un coup : make
*  Pour lancer le jeu et commencer à piocher : ./exec
...
---------------------------------------------------------------
Ouvre ton terminal Linux dans le dossier du projet et tape :
1. Pour compiler tous les fichiers d'un coup :
   make
3. Pour lancer le jeu et commencer à piocher :
   ./exec
...
(Bonus) Si tu veux nettoyer les fichiers temporaires après avoir joué :
 ...
 C'EST QUOI LE FLIP 7 ?
---------------------------------------------------------------
C'est un jeu de cartes de "Stop ou Encore" ultra addictif qui se joue de 2 à
5 joueurs. À ton tour, tu as deux choix :
...
pour la manche.
 ...
 Comment gagner ?
- Fais un "Flip 7" : Accumule 7 cartes différentes sans exploser pour obtenir
un bonus géant de +15 points et arrêter la manche.
- Sois le premier à atteindre 200 points au total des manches !
